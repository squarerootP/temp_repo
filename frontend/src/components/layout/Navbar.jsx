...
function NavBar() {
  ...
  return (
    <nav className='bg-primary p-2 shadow-lg'>
      <div className='flex items-center justify-between max-w-7xl mx-auto flex-row'>
        ...
        <div className='hidden md:flex flex-grow items-center justify-center space-x-10'>
          <Link to='/home' className='text-white hover:text-green-200 transition duration-150'>
            Home
          </Link>
          <Link to='/books' className='text-white hover:text-green-200 transition duration-150'>
            Books
          </Link>
          <Link to='/about' className='text-white hover:text-green-200 transition duration-150'>
            About
          </Link>
          <Link to='/contact' className='text-white hover:text-green-200 transition duration-150'>
            Contact
          </Link>
        </div>
        {!isLoggedin ? (
