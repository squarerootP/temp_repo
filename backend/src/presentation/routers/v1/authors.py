...
from backend.src.infrastructure.persistence.repository_impl.library_repos_impl.author_repository_impl import \
    AuthorRepositoryImpl
from backend.src.infrastructure.web.auth_provider import has_role
from backend.src.presentation.schemas.library_schemas import author_schema
