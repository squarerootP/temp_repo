...
class SearchForBooksWithAI:
    """
    Use case: The user provides a query and then we search for books that match the query text-base and semantically.
    """
    ...
    def execute(
        self, current_user, session_id: str, query: str) -> ChatMessage:
        ...
        response = self.rag_repo.search_for_books_with_ai(
