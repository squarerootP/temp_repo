# backend/src/infrastructure/rag/graph_rag/embedder/google_emb.py

import os
from typing import Any, Dict, cast

from langchain.text_splitter import RecursiveCharacterTextSplitter
# Import the standard tool factory
...
# --- RetrieverInput class is REMOVED ---
# The create_retriever_tool factory handles the schema automatically.
...
def get_retriever_tool():
    ...
    # Use the standard create_retriever_tool factory
    retriever_tool = create_retriever_tool(
        retriever,
        "Document_Retriever", # This name must match the one in your prompt
        """Useful for answering questions about Alice in Wonderland and Project Gutenberg.
